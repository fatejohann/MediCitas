...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $especialidad = $_POST['update_specialityl'];
    ...
    $stmt = $conexion->prepare("UPDATE doctor SET especialidad = ?, nombre = ?, apellido = ?, gmail = ?, pass = ? WHERE usuario = ?");
      ...
      <?php if (isset($fetch)): ?>
         <div class="flex">
            ...
            <span>Especialidad:</span>
               <input type="text" name="update_speciality" value="<?php echo htmlspecialchars($fetch['especialidad']); ?>" class="box">
               <span>Nombre:</span>
